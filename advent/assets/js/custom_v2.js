...
jQuery(function($) {
    "use strict";
        ...
        if (stop > mainbottom) {
            $('.navbar_advent').addClass('past-main');
            $('.navbar_advent').addClass('effect-main')
        } else {
            $('.navbar_advent').removeClass('past-main');
       }
  ...
  // Collapse navbar on click
   ...
   $(document).on('click.nav','.navbar_advent-collapse.in',function(e) {
    if( $(e.target).is('a') ) {
